...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (id){
            case R.id.show_dialog:
                ...
                */
                builder.setPositiveButton(textId"nice", dialogListenet);
                builder.setNegativeButton(textId"nuuuu", dialogListenet);
                builder.setNeutralButton(textId"wala paki", dialogListenet);
                builder.show();
                break;
    ...
    private DialogInterface.OnclickListener dialogListenetg = new DialogInterface.OnclickListener {
        @Override
                public void onClick(DialogInterface dialog, int which){
            switch (which){
                    ...
                    case DialogInterface.BUTTON_Negative:
                        Toast.makeText(MainActivity.this, "Negative button clicked!", Toast.LENGTH_SHORT).show();
                        break;
                    case DialogInterface.BUTTON_Nuetral:
                        Toast.makeText(MainActivity.this, "Neutral button clicked!", Toast.LENGTH_SHORT).show();
                        break;
            }
        }
